...
import com.ss.hanarowa.domain.member.dto.request.MemberAuthRequestDTO;
...
public class JwtUtil {
	...
	public static Map<String, Object> authenticationToClaims(Authentication authentication) {
		MemberAuthRequestDTO d = (MemberAuthRequestDTO)authentication.getPrincipal();
		MemberAuthRequestDTO dto = new MemberAuthRequestDTO(d.getEmail(), "" ,d.getRole());
