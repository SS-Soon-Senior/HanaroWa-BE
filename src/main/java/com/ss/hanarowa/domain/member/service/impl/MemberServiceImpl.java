...
public class MemberServiceImpl implements MemberService {
	...
	public void credentialRegist(MemberRegistRequestDTO memberRegistRequestDTO) {
		memberRepository.findByEmail(memberRegistRequestDTO.getEmail()).ifPresent(member -> {
	...
	@Override
	public void infoRegist(MemberInfoRequestDTO memberInfoRequestDTO, long id) {
	...
	@Override
	public void modifyInfo(MemberInfoRequestDTO memberInfoRequestDTO, long id) {
		Member member = memberRepository.findById(id).orElseThrow();
